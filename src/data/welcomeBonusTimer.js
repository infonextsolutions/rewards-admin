  ...
  async getWelcomeBonusTimerRules() {
    try {
      ...
      return {
        ...
        maxGamesWithBonusTasks: data.maxGamesWithBonusTasks || 3,
        maxBonusTasksPerGame: data.maxBonusTasksPerGame || 3,
  ...
  async updateWelcomeBonusTimerRules(configData) {
    try {
      ...
      const apiPayload = {
        ...
        maxGamesWithBonusTasks: configData.maxGamesWithBonusTasks || 3,
        maxBonusTasksPerGame: configData.maxBonusTasksPerGame || 3,
