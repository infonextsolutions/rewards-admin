...
const Dashboard = () => {
  ...
  // Keep hardcoded data for other components (not changing UI as requested)
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 lg:p-6">
      ...
      <div className="mb-6">
        <TopPlayedGameSnapshot data={staticData.topGame} loading={loading} />
      </div>

      {/* Tables Section */}
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        {/* Revenue vs Reward Cost Table */}
        <RevenueVsRewardTable data={staticData.revenueData} loading={loading} />

        {/* Attribution Performance Table */}
        <AttributionPerformanceTable
          data={staticData.attributionData}
          loading={loading}
        />
      </div>
    </div>
