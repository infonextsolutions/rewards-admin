  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-gray-600">
                Manage daily engagement challenges, XP multipliers, and reward
                structures for enhanced user retention
              </p>
            </div>
      ...
      <DeleteConfirmationModal
        ...
        message={
          deletingChallenge
            ? `Are you sure you want to delete "${deletingChallenge.title}"? This action cannot be undone.`
            : ""
        }
