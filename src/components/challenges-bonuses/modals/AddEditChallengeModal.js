          ...
          if (result.success && result.data) {
            setGamesList(
              result.data.map((game) => ({
                id: game._id || game.id || game.offerId,
                title: game.title || game.name || game.anchor,
                gameId: game.gameId || game._id || game.id || game.offerId,
                // Store additional fields for bitlabs compatibility
                ...(game.click_url && { clickUrl: game.click_url }),
