        ...
        <div className='flex items-center gap-1'>
          {type === 'select' ? (
            <select
              ...
              onKeyPress={(e) =>
                e.key === 'Enter' && handleCellSave(item, field)
              }
              autoFocus
            >
      ...
      case 'XP Tiers':
        return (
          <tr className='bg-[#ecf8f1]'>
            <th className='text-left py-4 px-3 font-semibold text-[#333333] text-sm'>
              XP Tier
            </th>
            <th className='text-center py-4 px-2 font-semibold text-[#333333] text-sm'>
              XP Range
            </th>
            <th className='text-left py-4 px-2 font-semibold text-[#333333] text-sm'>
              Access Benefits
            </th>
            <th className='text-center py-4 px-2 font-semibold text-[#333333] text-sm'>
              Status
            ...
            <td className='py-4 px-2 text-center'>
              <div className='flex justify-center'>
                {renderToggle(
                  ...
                  () =>
                    onToggleStatus &&
                    onToggleStatus({ ...item, enabled: !item.enabled }),
                )}
              </div>
            </td>
            <td className='py-4 px-2'>
